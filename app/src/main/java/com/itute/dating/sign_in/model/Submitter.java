...
public class Submitter {
    ...
    public void addNewUser(String uid, String displayName, String photoURL, Map<String, Object> address, String phone, int gender, long timestamp,
                           String hobby, String star, String job, String language, String religion, Map<String, Object> search) {
        User user = new User(displayName, photoURL, address, phone, gender, timestamp, hobby, star, job, language, religion, uid, search);
